...
def main():
    ...
    logger.info("8/15: mesh_stats (1kmメッシュ統計)")
    ...
    logger.info("9/15: census_municipality (市区町村・都道府県別 基本集計)")
    ...
    logger.info("10/15: resident_registry (住民基本台帳 人口・世帯数・人口動態)")
    build_resident_registry("data/resident_registry", app_id)

    # 11. 経済センサス‐活動調査 産業横断的集計
    logger.info("11/15: economic_census (経済センサス 産業横断的集計)")
    ...
    logger.info("12/15: census_commuting (従業地・通学地集計)")
    ...
    logger.info("13/15: manufacture (工業統計調査 市区町村別・産業中分類別)")
    ...
    logger.info("14/15: local_finance (地方財政状況調査)")
